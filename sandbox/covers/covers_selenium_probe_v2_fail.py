...
def main():
    ...
    try:
        ...
        if not calendar["week_link"]:
            raise RuntimeError(
                "Could not find the rendered Week 9 calendar link."
            )

        historical_url = calendar["week_link"]["href"]

        print("Historical Week 9 URL:", historical_url)
